...
export default async function AdminRecordsPage({
  ...
  let query = supabase
    ...
    .select("id, submission_id, job_number, submitted_at, position_of_work, flocoat")
  ...
  return (
    <div className="space-y-5">
      ...
      <form className="grid grid-cols-2 gap-2" action="/admin">
        ...
        {(records ?? []).map((r) => (
          ...
          >
            <div className="flex justify-between items-center">
              <span className="font-semibold text-paper">{r.job_number}</span>
